...
export default function NewCommentForm({feature}:{feature: Feature}) {
    ...
    if(!can(user,'manage_comments')){
        return (
            <div className="text-center text-gray-600">You don't have permission to leave comments</div>
        );
    }

return(
    <form onSubmit={createComment} className="flex items-center px-3 py-2 rounded-lg bg-gray-50 dark:bg-gray-800 mb-4">
       <div>
            <TextAreaInput 
            rows={1}
            value={data.comment}
